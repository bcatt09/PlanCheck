...
namespace PlanCheck.Checks
{
    public class ProtonGantryAngleChecks : PlanCheckBaseProton
    {
        ...
        public override void RunTestProton(IonPlanSetup plan)
        {
            ...
            List<int> G1CommissionedGantryAngles = new List<int> { 0, 5, 15, 30, 45, 50, 60, 75, 80, 90, 95, 105, 120, 135, 145, 150, 165, 170, 180 };
            List<int> G1CommissionedCouchAngles = new List<int> { 0, 180, 270 };

            List<int> G2CommissionedGantryAngles = new List<int> { 0, 5, 15, 30, 45, 50, 60, 75, 80, 90, 95, 105, 120, 135, 145, 150, 165, 170, 180 };
